...
async def create_restaurant_in_db(name, description, feedback, session):
    new_restaurant = Restaurants(name=name, description=description, feedback=feedback)
...
async def create_restaurant(new_restaurant: RestaurantCreate, session: AsyncSession = Depends(get_async_session)) -> RestaurantBase:
    await create_restaurant_in_db(new_restaurant.name, new_restaurant.description, new_restaurant.feedback, session)
